...
namespace BasicRPGTest_Mono.Screens
{
    class ScreenLoading : GameScreen
    {
        ...
        {
            string progress = (DataPackManager.loadProgress * 100).ToString("#.##");
            ...
            _spriteBatch.DrawString(FontLibrary.getFont("main"), $"{DataPackManager.loadStatus}", new Vector2(500, 50), Color.White);
            _spriteBatch.End();
        }
    }
}
